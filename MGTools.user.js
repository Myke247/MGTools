...
function MGA_loadJSON(key, fallback = null, autoRecover = true) {
    ...
    try {
        ...
        console.error('❌ [MGA_loadJSON] Unexpected failure for key', key, err);
        return (typeof fallback === 'undefined') ? null : fallback;
    }
}
...
window.MGA_debugStorage = function() {
    ...
    function createUnifiedUI() {
        ...
        // Icon mapping
        const icons = {
            pets: 'data:image/png;base64,',
            abilities: '✨',
            seeds: '🌱',
            values: '💎',
            timers: '⏱️',
            rooms: '🏠',
            shop: 'data:image/png;base64,',
            tools: '🔧',
            settings: '⚙️',
            hotkeys: '⌨️',
            protect: '🔒',
        ...
        primaryTabs.forEach(tabName => {
            ...
            // Check if icon is a PNG (base64 data URI) or emoji
            if (icons[tabName] && icons[tabName].startsWith('data:image/png;base64,')) {
                const fallbackEmoji = tabName === 'shop' ? '🛒' : (tabName === 'pets' ? '🐾' : '📌');
                item.innerHTML = '<img src="' + icons[tabName] + '" style="width: 24px; height: 24px; object-fit: contain; filter: none !important; -webkit-mask: none !important; mask: none !important; mix-blend-mode: normal !important;" onerror="this.outerHTML=\'' + fallbackEmoji + '\';">';
            } else {
    ...
    function hideWeatherCanvases() {
        ...
        productionLog(`🌧️ [WEATHER] Hiding ${canvases.length} weather canvas(es)`);
    ...
    function showWeatherCanvases() {
        const canvases = document.querySelectorAll('canvas.WeatherCanvas');
        productionLog(`🌧️ [WEATHER] Showing ${canvases.length} weather canvas(es)`);
        canvases.forEach(canvas => {
    ...
    function applyWeatherSetting() {
        productionLog(`🌧️ [WEATHER] Applying weather setting: hideWeather=${UnifiedState.data.settings.hideWeather}`);
...
<body>
    ...
    function setupToolsTabHandlers(context = document) {
        ...
        if (hideWeatherCheckbox && !hideWeatherCheckbox.hasAttribute('data-handler-setup')) {
            ...
            hideWeatherCheckbox.addEventListener('change', (e) => {
                productionLog(`🌧️ [WEATHER] Checkbox changed to: ${e.target.checked}`);
                UnifiedState.data.settings.hideWeather = e.target.checked;
                MGA_saveJSON('MGA_data', UnifiedState.data);
                applyWeatherSetting();
                productionLog(`🌧️ [WEATHER] Weather effects ${e.target.checked ? 'hidden' : 'shown'}`);
            });
            productionLog('🌧️ [WEATHER-DEBUG] Event listener attached successfully');
        } else if (hideWeatherCheckbox) {
            productionLog('🌧️ [WEATHER-DEBUG] Checkbox already has handler, skipping');
        } else {
    ...
    function loadSavedData() {
        ...
        if (loadedData && loadedData.sellBlockThreshold !== undefined) {
            ...
            UnifiedState.data.sellBlockThreshold = 1.0;
            productionLog('📦 [STORAGE] Initialized sell block threshold to default (1.0)');
        }

...
**Version 3.6.0** | All-in-one assistant for Magic Garden with a beautiful unified UI

![MGTools](https://img.shields.io/badge/version-3.6.0-blue) ![Status](https://img.shields.io/badge/status-beta-orange)
...
- **v3.6.0**: 🐛 **Bug Fixes** - Notification settings now persist! Purple indicator now BRIGHT MAGENTA - impossible to miss when outdated!

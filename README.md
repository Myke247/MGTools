...
**Version 3.2.8** | All-in-one assistant for Magic Garden with a beautiful unified UI

![MGTools](https://img.shields.io/badge/version-3.2.8-blue) ![Status](https://img.shields.io/badge/status-stable-green)
